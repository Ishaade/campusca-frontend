...
function CreateRoom() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create room through backend API. Server generates the room code.
      const payload = {
        name: formData.name,
      ...
      setSuccess(`Room "${created.name}" created successfully! Code: ${created.code}`);
        ...
        <div className="container">
          <div className="flex items-center justify-between py-4">
            <div>
              ...
              <p className="text-gray-600">Set up a new quiz room for your students</p>
            </div>
            <button
